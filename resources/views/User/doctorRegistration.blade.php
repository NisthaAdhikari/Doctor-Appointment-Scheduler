        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                <div class="panel-heading">
                    <div class="row">
                        <div>
                            <h3 style="color: #53A3CD">Doctor Registration</h3>
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form id="doctor-registration-form" action="{{route('registerDoctor')}}" method="post" role="form" style="display: block;">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    <input type="email" autocomplete="off" name="email" id="email" tabindex="1" class="form-control" placeholder="Enter Email" required>
                                </div>


                                <div class="form-group">

                                    <input type="text" name="mobile" id="mobile" tabindex="1" class="form-control" placeholder="Enter Mobile Number" required>
                                </div>

                                <div class="form-group">
                                    <input type="password" autocomplete="off" name="doctorPassword" id="doctorPassword" tabindex="2" class="form-control" placeholder="Password" aria-describedby="passwordHelpBlock"
                                    required>
                                ...
                                <div class="form-group">
                                    <input type="password" name="doctorConfirmPassword" id="doctorConfirmPassword" tabindex="2" class="form-control" placeholder="Confirm Password" required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <a href="{{route('getLoginPage')}}" tabindex="4" class="form-control btn" style="background-color: lightgrey">Log in</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script>
    ...
    $('#doctorPassword, #doctorConfirmPassword').on('keyup', function () {
