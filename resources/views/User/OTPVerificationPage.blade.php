    ...
    <div class="row">
                        ...
                        <div class="box-body" style="margin-top: 10px">
                            <div class="col-md-8">
                                ...
                                <div class="row" id="{{$t->id}}" data-text="{{$t->name}}">
                                    ...
                                    <div class="col-md-6" style="margin-left: 70px; margin-top: 10px">
        ...
        <div class="col-md-5">
            ...
            <div class="appointment-form">
                Enter code recieved:
                <form enctype="multipart/form-data" id="appointmentForm" action="{{route('verifyOTP',[$appointmentNo,$number])}}" method="post">
                    {{csrf_field()}}
                    <div class="form-group">

                        <div class="errorMessage" id="Patient_name_em_" style="display:none"></div>
                    </div>
                    <div class="form-group">

                        <input class="form-control" placeholder="OTP here" name="code" id="code" required>
                        <small class="text-center" style="color: grey; font-size: 11px; font-weight: bolder">Confirmation message will be sent to your number upon entering valid OTP</small>

                    </div>
                    <button id="confirm" class="confirm-btn">
                        Verify
                    </button>
                </form>
