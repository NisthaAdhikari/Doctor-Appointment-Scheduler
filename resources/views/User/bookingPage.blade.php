                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                                ...
                                <input type="text"  class="form-control typeahead" placeholder="Specialization" style="width: 250px; " autocomplete="off">
                        ...
                        {{--<div class="col-lg-12">--}}
                            {{--<div class="row">--}}
                                {{--<div class="form-group" style="margin-left: 30px">--}}
                                    {{--<input type="text" class="form-control search-slt" name="speciality" placeholder="Speciality" style="width: 250px; ">--}}
                                {{--</div>--}}
...
<div style="margin-top: 100px">
    @if (session('status'))
        <div class="alert-dismissable" style="margin-left: 150px; width: 990px; background-color: rgba(172,234,212,0.51); border-color: skyblue; height: 50px; font-style: italic; color:red; font-size: 14px;font-weight: bolder; text-align: center; padding-top: 15px">
            {{ session('status') }}
        </div>
    @endif
@if($test)
