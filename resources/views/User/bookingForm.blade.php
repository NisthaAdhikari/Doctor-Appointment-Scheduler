...
<div class="container" style="margin-top: 100px; margin-right: 90px">
    <div class="row">
        <div class="col-md-6">
            @if($test)
                @foreach($test as $t)

                    <div class="box" style="margin-left: 50px; width: 1000px; height: 500px">
        ...
        <div class="col-md-5">
            ...
            <div class="alert" style="margin-top: 10px; background-color: rgba(46,33,65,0.51);">
                <h4 style="margin-bottom: 5px">Your Chosen Appointment Time</h4>
                <span style="font-size: 13px"> <i class="fa fa-calendar" aria-hidden="true" style="margin-bottom: 5px"></i>
                            {{$day}}, {{$date}}  </span> <span style="font-size: 13px"><br><i class="fa fa-clock-o" aria-hidden="true" ></i>
                            {{$bookedtime}}</span>
            ...
            <div class="appointment-form">
                ...
                <form enctype="multipart/form-data" id="appointmentForm" action="{{route('bookingConfirm',[$t->id,$day,$date,$bookedtime])}}" method="post">
                    {{csrf_field()}}
                    <div id="appointment-detail-box">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Patient's name" name="patientName" id="patientName" type="text" maxlength="255" required>
                            <div class="errorMessage" id="patientName" style="display:none"></div>
                        </div>

                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-addon no-radius">
                                    +977
                                </div>
                                <input required class="form-control" autocomplete="off" placeholder="Patient's mobile no." name="mobile" id="mobile" type="text" maxlength="10" >
                            </div>

                                    <div class="errorMessage" id="mobile" style="color: red; font-size:13px">
                                        @if(count($errors) > 0)
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control resize-vertical" placeholder="Reason for your visit.." rows="3" name="diseaseDescription" id="diseaseDescription"></textarea>
                            <div class="errorMessage" id="appointment_sms_code_error"></div>
                            <small class="text-center" style="color: grey; font-size: 11px; font-weight: bolder">You will receive an SMS with a verification code</small>
                        </div>


                        <div class="form-group  text-center">

                            <button id="confirm-appointment" class="confirm-btn" name="confirm-appointment">
                                Confirm Appointment
                            </button>

                            <!-- submitting icon -->
                            {{--<div class="submitting-booking hide disabled conferm-btn" style="padding: 8px; width: 256px; margin: 0 auto; opacity: 0.6">--}}
                                {{--Confirm Appointment</div>--}}
