...
<div class="box-body">
    <div class="form-group">
        ...
        <input type="password" class="form-control txtDoctorPassword" name="doctorPassword">
...
<div class="box-body">
    <div class="form-group">
        ...
        <input id="imageUpload" name="imagePath" type='file' onchange="displayImage(this, 'colorImage',append=true);" title="select your image" />
    </div>
</div>
